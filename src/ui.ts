...
<section class="cta-band" id="install">
  ...
  <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap;position:relative;z-index:2">
    ...
    <a class="btn ghost" href="https://github.com/" target="_blank" rel="noopener">View the repo</a>
  </div>
...
<footer>
  <div class="foot-grid">
    ...
    <div>
      <h4>Meta</h4>
      <ul><li><a href="https://github.com/" target="_blank" rel="noopener">GitHub</a></li><li><a href="#">Stay in the loop</a></li></ul>
    </div>
  </div>
